...
@section('page-subtitle', 'Histori peminjaman yang telah saya proses')

@section('sidebar-menu')
    <li><a href="{{ route('petugas.dashboard') }}"><i class="fas fa-th-large"></i><span>Dashboard</span></a></li>
    <li><a href="{{ route('petugas.borrowings.index') }}"><i class="fas fa-exchange-alt"></i><span>Kelola Peminjaman</span></a></li>
    <li><a href="{{ route('petugas.verify-qr.index') }}"><i class="fas fa-barcode"></i><span>Verifikasi Kode</span></a></li>
    <li><a href="{{ route('petugas.borrowings.history') }}" class="active"><i class="fas fa-history"></i><span>Riwayat Peminjaman</span></a></li>
...
<div class="section">
    <h2 class="section-title">Riwayat Peminjaman Saya ({{ $requests->total() }})</h2>
    ...
    @else
        <div style="text-align:center;padding:60px;color:#999;">
            ...
            <h3 style="margin-top:16px;font-size:1rem;">Belum ada riwayat peminjaman yang Anda proses</h3>
        </div>
    @endif
</div>
@endsection
