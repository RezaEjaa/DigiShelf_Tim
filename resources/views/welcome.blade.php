...
<body>
    ...
    <!-- Tambah 1: Deskripsi Singkat -->
    <p>Platform perpustakaan digital untuk kemudahan akses membaca dan peminjaman buku daring.</p>
    ...
    <div style="display: flex; gap: 20px; margin-top: 15px; color: #ffffff;">
    <!-- Instagram -->
    <div style="display: flex; align-items: center; gap: 8px;">
        ...
        <h3 style="margin: 0; font-size: 14px; color: #ffffff; font-weight: normal;">Digishelf</h3>
    </div>
